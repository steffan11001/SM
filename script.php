...
exec('python /home/pi/Desktop/lab8/cpin7h.py');
}
if (isset($_POST['roff']))  //  Red Off
{
exec('python /home/pi/Desktop/lab8/cpin7l.py');
}
if (isset($_POST['gon']))  // Green On
{
exec('python /home/pi/Desktop/lab8/cpin5h.py');
}
if (isset($_POST['goff']))  // Green Off
{
exec('python /home/pi/Desktop/lab8/cpin5l.py');
}
if (isset($_POST['bon']))  // Blue On
{
exec('python /home/pi/Desktop/lab8/cpin3h.py');
}
if (isset($_POST['boff']))  // Blue Off
{
exec('python /home/pi/Desktop/lab8/cpin3l.py');
